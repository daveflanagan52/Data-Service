...
import {
  faCheck, faQuestion, faSave, faSearch, faTimes,
  ...
  if (device) {
    return (
      ...
      >
        ...
        <pre style={{ color: '#000000', marginBottom: 0 }}>
          curl -X
          <span style={{ color: '#0000e6' }}>'POST'</span>
          {' '}
          <span style={{ color: '#0f69ff' }}>\</span>
        </pre>
        <pre style={{ color: '#000000', marginBottom: 0 }}>
          {' '}
          <span style={{ color: '#0000e6' }}>
            'https://data.daveflanagan.ovh/api/v1/data/
            {device.privateKey}
            '
          </span>
          {' '}
        ...
        <pre style={{ color: '#000000', marginBottom: 0 }}>
          {' '}
          -H
          <span style={{ color: '#0000e6' }}>'accept: application/json'</span>
          {' '}
          <span style={{ color: '#0f69ff' }}>\</span>
        </pre>
        <pre style={{ color: '#000000', marginBottom: 0 }}>
          {' '}
          -H
          <span style={{ color: '#0000e6' }}>'Content-Type: application/json'</span>
          {' '}
          <span style={{ color: '#0f69ff' }}>\</span>
        </pre>
        <pre style={{ color: '#000000', marginBottom: 0 }}>
          {' '}
          <span style={{ color: '#44aadd' }}>-d</span>
          {' '}
          <span style={{ color: '#0000e6' }}>
            '
            {'{'}
      ...
      {(props) => (
        <Form>
          ...
          >
            ...
            <FormCheckSwitch id="private" name="private" value text="Private?" />
